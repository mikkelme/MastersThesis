...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.49\textwidth}
		\centering
		\includegraphics[width=0.65\textwidth]{../thesis/figures/baseline/drag_Ff_10Å.pdf}
		\caption{$K = \infty$, $v = \SI{20}{\frac{m}{s}}$ (10 Å sliding).}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.49\textwidth}
		\centering
		\includegraphics[width=0.65\textwidth]{../thesis/figures/baseline/drag_Ff_100Å.pdf}
		\caption{$K = \infty$, $v = \SI{20}{\frac{m}{s}}$ (100 Å sliding).}
	  \end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.49\textwidth}
		\centering
		\includegraphics[width=0.65\textwidth]{../thesis/figures/baseline/drag_Ff_10Å_K10_v1.pdf}
		\caption{$K = \SI{10}{\frac{N}{m}}$, $v = \SI{1}{\frac{m}{s}}$ (10 Å sliding).}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.49\textwidth}
		\centering
		\includegraphics[width=0.65\textwidth]{../thesis/figures/baseline/drag_Ff_100Å_K10_v1.pdf}

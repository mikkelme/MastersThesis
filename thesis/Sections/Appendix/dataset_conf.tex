\chapter{Dataset Kirigami patterns}\label{sec:dataset_conf}
...
\begin{enumerate}
    \item 68 Tetrahedron configurations shown in~\crefrange{fig:T0}{fig:T2}.
    \item 45 Honeycomb configurations shown in figure~\crefrange{fig:H0}{fig:H1}.
    \item 100 Random walk configurations shown in figure~\crefrange{fig:R0}{fig:R3} and supplementary details are given in~\cref{tab:RW_details}.
\end{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/dataset/popup_0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/dataset/popup_1.png}
...
\begin{figure}[!t]
    \centering
    \vspace*{2.5cm}
    \includegraphics[width=\linewidth]{figures/dataset/popup_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/dataset/honeycomb_0.png}
...
\begin{figure}[!t]
    \centering
    \vspace*{2.5cm}
    \includegraphics[width=\linewidth]{figures/dataset/honeycomb_1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/dataset/RW_0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/dataset/RW_1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/dataset/RW_2.png}
...
\begin{figure}[H]
    \centering
    \vspace*{2.5cm}
    \includegraphics[width=\linewidth]{figures/dataset/RW_3.png}
...
\begin{longtable}{|C{0.9cm}|C{0.8cm}|C{0.8cm}|C{0.8cm}|C{3cm}|C{1.5cm}|C{1.5cm}|C{0.8cm}|C{0.8cm}|C{1cm}|C{1cm}|} \hline
    Index & Num. \newline walks & Max.\ steps & Min.\ dis. & Bias \newline (dir., temp.) & Connection & Avoid invalid & RN6 & Grid start & Centering & Stay or break  \ \\ \hline
    ...
    \caption{Random walk parameters corresponidng to the configurations shown in figure \crefrange{fig:R0}{fig:R3}. All configurations have the default parameters: Periodic = True, Avoid clustering = 10.}

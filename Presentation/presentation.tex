...
\title[Short Title]{Tuning friction properties of graphene sheets using kirigami inspired cuts and inverse design} % The short title in the optional parameter appears at the bottom of every slide, the full title in the main parameter is only on the title page
...
\begin{frame}
	...
	\begin{figure}
		\centering    
		\movie[open]{\includegraphics[width=\textheight, keepaspectratio]{figures/contact_lines_black.png}}{figures/contact_lines_black.mov}

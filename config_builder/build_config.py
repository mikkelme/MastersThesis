...
if __name__ == "__main__":
    ...
    RW = RW_Generator(size = (62, 106), stay_or_break = True, num_walks = 1, max_steps = 30, min_dis = 4, bias = [(0.05, 1), 1], RN6 = False, periodic = True, avoid_unvalid = False, grid_start = True, center_elem = 'full', centering = False, avoid_clustering = 2)

...
def RW_dataset(shape = (62,106)):
    ...
    SET = []
    SET.append(RW_Generator(size = (62, 106), num_walks = 1, max_steps = 70, min_dis = 0, bias = [(1, -1), 1], RN6 = False, periodic = True, avoid_unvalid = False, grid_start = True, center_elem = False, center = False))

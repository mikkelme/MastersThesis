...
\hl{Talk about the figures here}
...
% zero load which makes the definition in \cref{eq:mu_def2} the common
% choice. Especially, if the amontos break down and the linearity is not present
% we might talk about a changing COF and thus \cref{eq:mu_def2} is the only
% reasonable choice.  
...
One such method arose from the \textit{atomic force microscope}, which consist

...
corresponds too smooth sliding, $1<\eta \le 4.6$ to a single slip and so on. These static derivation lays out the foundamental probabilities for being in one of the regimes stick-slip regimes. Notice that increasing the spring constant $K$ (stiff spring) will decrease the possibilities for stick-slip behaviour. This also agrees with Bonelli \hl{Talk about this.}

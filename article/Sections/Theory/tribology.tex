...
Going from a micro- to nanoscale, on the order of \SI{e-9}{m} meter, it has been
...
$A_{\text{atom}}$ is the associated surface area, they found a consistent
...
maintained. This result emphasizes that the contact area is still expected to be play an important role in nanoscale asperity theory. It is simply the definition of the contact area that undergoes a change when transistioning from micro- to
nanoscale. 
...
reported on the dependence of friction force on contact area (\hl{to do best of
my knowledge}). One reasonable explanation for this is the idea that the contact
...
that some other mechanism is governing for friction at this level. Before diving
into alternative theoretical approaches to adress this issue we point out that the transistion between nanoscale asperities and atomic smooth surfaces is of outermost importance for the objective of this thesis. By introducing kirigami cuts and stretching the sheet we expect to see an out of plane buckling which might induce an ensemble of asperities. Hence, we might hypothesize that such a transsition will contribute to a significant change in the goverening mechanism of friction bridgering two (poorly understood) theoretical domains 
\\
\\
%
%

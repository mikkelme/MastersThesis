...
\begin{enumerate}
  \item  How can we design a \acrshort{MD} simulation that provides a stable foundation for an investigation of friction behavior for a Kirigami sheet sliding on a substrate? How do our specific system and condition choices relate to the theoretical understanding?
  \item Can we achieve out-of-plane buckling for a graphene sheet using Kirigami cuts and stretch? How can we design a numerical procedure to generate a variety of designs which include out-of-plane buckling but also some randomized designs for an improved variety in the machine learning data?

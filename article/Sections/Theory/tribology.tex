...
% merely are going to point to the FK model for the understanding of stick-slip behvaiour and the concept of commensurability.
...
\subsection{Expected frictional properties}\label{sec:expected_prop}
...
One of the earlist tribological simulations \cite{penkov_tribology_2014} of graphene was Bonelli et al. \cite{bonelli_atomistic_2009} in 2009 tight-binding... 

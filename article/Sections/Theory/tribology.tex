...
% \hl{Include comment about initial rise in friction with temperature due to thermally activated formation and rupturing of mul- tiple contacts?}
...
\subsubsection{Mass}
% Maybe include this directly when introducing the attempt rate
...
\begin{align}
  ...
  \label{eq:static_H}
\end{align}
with $vt$ being the moving body position. The friction regime is determined by the

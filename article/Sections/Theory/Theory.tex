...
The first studies of frictions took place at a macroscopic level on the scale of visible everyday objects. The work of Leonardo da Vinci (1452–1519), Guillaume Amontons (1663-705) and Charles de Coulomb (1736-1806) all contributed to what is known as Amontons’ law. Amontons’ law describes the friction force accuring when starting and keeping a solid block moving against a solid surface. This emperical law states that friction force tangential to the moving direction is entirely independent of contact area and sliding velocity. Instead it relies on the normal force $F_N$ and the material specific friction coefficient $\mu$ as
\begin{align*}
  F_f = \mu \ F_N.
\end{align*}

Further it distinguish between \textit{static friciton} and \textit{kinetic friction} as the cases of a non moving contact and a moving sliding contact resepectively. Each type of friction comes with its own friction coefficient, $\mu_s$ and $\mu_k$ for static and kinetic friction respectively, usually with values lower than one and $\mu_s \ge \mu_k$. \cite{gnecco_meyer_2015}[p. 6]

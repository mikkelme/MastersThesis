...
the angle between bond $ij$ and $jk$. The summation is over all neighbors $j$
...
order (bond strength), which is environment specific and decreases with increasing bond coordination (number of neighbors for a given atom). The potential energy is taken to have the form
\begin{align*}

...
\rangle} \propto \sqrt{t}$ at $t \ll m/\alpha$ to the diffusive regime $\sqrt{\langle x^2(t)\rangle} \propto \sqrt{t}$ at $t \gg m/\alpha$. This relates to the discussion about the ballistic and diffusive regime regarding velocity which is inversely proportional to the time between collissions  \hl{comment a bit more maybe}.

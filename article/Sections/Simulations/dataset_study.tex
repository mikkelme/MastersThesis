...
We then use these suggested learning rates for the architecture search. We look at the total validation loss and the validation R2 score for the mean friction. 
...
%   \begin{subfigure}[t]{0.49\textwidth}
%       \centering
%       \includegraphics[width=\textwidth]{figures/ML/A_search_R2.pdf}
%       \caption{}
%       % \label{fig:}
%   \end{subfigure}
%   \hfill
%   \begin{subfigure}[t]{0.49\textwidth}
%       \centering
%       \includegraphics[width=\textwidth]{figures/ML/A_search_val_loss.pdf}
%       \caption{}
%       % \label{fig:}
%   \end{subfigure}
%   \hfill
%   \begin{subfigure}[t]{0.49\textwidth}
%       \centering
%       \includegraphics[width=\textwidth]{figures/ML/A_search_epoch.pdf}
%       \caption{}
%       % \label{fig:}
%   \end{subfigure}
%   \hfill
%   \begin{subfigure}[t]{0.49\textwidth}
%       \centering
%       \includegraphics[width=\textwidth]{figures/ML/A_search_num_param.pdf}
%       \caption{}
%       % \label{fig:}
%   \end{subfigure}
%   \hfill

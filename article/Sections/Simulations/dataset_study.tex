...
\hl{Hard to follow. Go over this.}
...
% ising lowering and porosity target is very easy, but the ising max is difficult since it gets stuck in checkboard regions not aligning

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\linewidth]{figures/search/ising_max_history.pdf}
  \caption{Converge fast in the beginning but then often get stuck with two regions of checkboard not aligning. }

...
From \cref{fig:A_search_perf} we find that models like S(8-32)D(8-12) gives reasonble performance. When looking at the selected validaiton set in
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/ML/mom_weight_search_perf.pdf}
  \caption{\hl{UPDATE FIGURE WITH RIGHT DATA}}
  \label{fig:mom_weight_search_perf}
\end{figure}  


\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/ML/mom_weight_search_compare_perf}
  \caption{\hl{UPDATE FIGURE WITH RIGHT DATA}}

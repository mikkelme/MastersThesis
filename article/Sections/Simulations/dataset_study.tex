...
Despite the fact that our machine learning analysis indicates that the model are not generalized for the prediction on new configurations we investigate the appraoch of using a gentic algorithm for an accelerate search.

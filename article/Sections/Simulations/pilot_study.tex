...
% TO-DO: Look at friction force graph again and reconsider whether we have stick-slip. The small oscillations is probably noise, and since the big oscialltions go by smooth curves this is actually more likely to be smooth sliding. I guess looking at the period in connection with the lattice spacing show whether it is thoose curves we should look at or the smaller ones result from a lot of small slips...
...
The friction simulation is governed by a set of parameters where some is kept constant while other is varied to gain insight in the frictional properties. These parameters can be categorised into three main categories of different purpose as described in \cref{tab:param}. 

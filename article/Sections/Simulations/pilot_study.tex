...
is more evident from the parameter investigation from~\cref{fig:main_param} We
notice also that the two orders of magnitude increase in normal load did not

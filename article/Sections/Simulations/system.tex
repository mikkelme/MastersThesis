...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{0.70\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/system/system_topview_annotated.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/system/hon_stretch.png}
  \caption{Stretched Kirigami sheet against a substrate. The substrate is excluded from the image for better visability. The pattern used is the Honeycomb $(2,2,1,5)$ (see \cref{chap:system}) at a 100\% strain level.}

...
substrate stays in place. In \cref{fig:system} the system is displayed
...
The total system size in terms of atom count is given in \cref{tab:system_count} while the sheet length dimension is given in \cref{tab}

The total system size (without cuts in the sheet) is 27456 atoms, and the distribution into the various regions is shown in \cref{tab:system_count}. The length dimensions of the sheet is given in \cref{tab:sheet_dim}.

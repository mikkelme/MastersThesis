...
% the pattern generation search suppor the idea that machine learning can not be used to minimize friction further within our domain
% The generation search reveals Tetrahedron and Honeycomb patterns from the original data. It also revels that it is sensitive to translation.

...
% Defined friction properties of interest
% Dataset did not provide clues for minimization of friction but improved the scores for maximization and max drop 

...
For machine learning we can either try to extend the datatset to resolve the issue of the model not being generalized enough. We can also create a dataset for a single kirigami design and include some of the mentioned physical variables, temperature, sliding speed, scan direction, (still load), to approach the investigation from that side. 

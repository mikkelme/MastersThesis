...
Talk about dependence on drag speed, $dt$ and maybe $T$ and $K$ as well. Show how the number of cores per simulation scale to argue that running on just one core is smart for the next step of many simulations. 
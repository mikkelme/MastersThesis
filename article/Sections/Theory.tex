...
\begin{align*}
  ...
  \vec{v}(t) = v(0)e^{- \frac{\gamma t}{m}},
\end{align*}

where the solution predicts that brownian particle will come to a complete stop after a long time ${\vec{v}(t\to\infty) \to \vec{0}}$. This is in violation with the equipartion theorem
...
We notice the appereance of $\gamma$ meaning that the magnitude of the fluctuations increase both with friction and temperature.


%
%
% WORKING HERE
% Check if stuff below can be written into stuf above
%
%

...
% (Notice that we only introduce the thermostat for We do so in non important parts of the simulations as this might have some Side effects.. says Henrik.) By doing so we will sample the 

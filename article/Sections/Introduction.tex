...
In recent years an increasing amount of interest has gone into the studies
...
% Maybe use some of the things from introduction in \cite{Kim_2012}} 

% Look at \cite{zhang_tuning_2019} who lowers graphene friction by applying strain to the sheet. 

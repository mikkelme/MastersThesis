...
% $m$\nomenclature{$m$}{The mass of the object} is big. OR  $c$\nomenclature{$c$}{test}. C
% an we talk about \acrshort{ML}? Do I need to mention \acrshort{GA} which is short for \acrlong{GA}?
